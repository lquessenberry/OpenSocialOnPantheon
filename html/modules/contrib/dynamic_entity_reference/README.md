#Dynamic Entity Reference [![Build Status](https://travis-ci.org/jibran/dynamic_entity_reference.svg?branch=8.x-1.x)](https://travis-ci.org/jibran/dynamic_entity_reference)
##Overview
