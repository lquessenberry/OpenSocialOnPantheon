...
jQuery UI accordion library for any themes and modules that require it.

  - jQuery UI [Accordion documentation](https://jqueryui.com/accordion/)
  - jQuery UI [Accordion API documentation](https://api.jqueryui.com/accordion/)
